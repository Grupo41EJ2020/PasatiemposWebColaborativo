...
<head runat="server">
    <title>Detalles del videos</title>
</head>
<body>
    <fieldset>
    ...
    <p>
        <%: Html.ActionLink("Editar", "danielamaldonadognzEdit", new { id=Model.IdVideo }) %> |
        <%: Html.ActionLink("Regresar a la tabla", "danielamaldonadognz") %>
    </p>
