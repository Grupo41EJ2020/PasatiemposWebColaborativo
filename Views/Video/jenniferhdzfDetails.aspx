...
<head runat="server">
    <title>DETALLES DEL VIDEO:jenniferhdzf</title>
</head>
<body>
    <fieldset>
    ...
    <p>
        <%: Html.ActionLink("Editar", "jenniferhdzfEdit", new { id = Model.IdVideo })%> |
        <br />  
        <%: Html.ActionLink("Regresar a la tabla ", "jenniferhdzf")%>
    </p>
