...
<body>
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td>
                <%: Html.ActionLink("Editar", "Quique07DsEdit", new { id = item.IdVideo })%> |
                <%: Html.ActionLink("Ver detalles", "Quique07DsDetails", new { id = item.IdVideo })%> |
                <%: Html.ActionLink("Borrar", "Quique07DsDelete", new { id = item.IdVideo })%>
            </td>
            <td>
                <%: item.IdVideo %>
            </td>
